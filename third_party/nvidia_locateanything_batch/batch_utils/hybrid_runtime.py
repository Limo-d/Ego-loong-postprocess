...
_PROMPT = "Locate all the instances that match the following description: "
...
def load():
    ...
    if _model is None:
        ...
        _proc = AutoProcessor.from_pretrained(MODEL, trust_remote_code=True, use_fast=False)
        ...
        config.vision_config._attn_implementation = VISION_ATTN_MODE if VISION_ATTN_MODE != "auto" else "sdpa"
