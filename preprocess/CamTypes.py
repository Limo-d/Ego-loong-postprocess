# -*- coding: utf-8 -*-
# @FileName: CamTypes.py

"""
====================================================================================================
Project Camera Data Structure and Serialization (CamTypes.py)
====================================================================================================

Description:
    This module defines the data containers and serialization logic for processed Project 
...
Core Components:
    1. CamData: A dataclass representing a single synchronized camera frame, including 
       its spatial transformations (Camera-to-World, etc.) and the processed image.
    2. Cam: A container class for a sequence of CamData frames, managing global 
...
class Cam:
    """
    A sequence-level container for CamData, including export and serialization logic.

    Attributes:
        tss (List[int]): List of timestamps for all frames.
        cam (List[CamData]): List of per-frame data objects.
