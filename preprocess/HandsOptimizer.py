# -*- coding: utf-8 -*-
# @FileName: HandsOptimizer.py

"""
====================================================================================================
Project Hand Kinematics Optimizer (HandsOptimizer.py)
====================================================================================================
...
from preprocess.HandsTypes import MidpointFrameBuilder, HandData, Hands
...
class HandsOptimizer:
    ...
    def run(self, aria_hands: Hands) -> None:
        """
        Executes the full hand kinematics optimization pipeline.

        Args:
            aria_hands (Hands): The sequence-level hand container to be modified.
        """
        self._optimize_all_hands(aria_hands)
        print(f"[***] Smoothing pipeline finished using HandsOptimizer.")
