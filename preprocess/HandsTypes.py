...
"""
====================================================================================================
Project Hand Tracking Data Types and Kinematic Utilities (AriaHandTypes.py)
====================================================================================================

Description:
    This module defines the fundamental data containers and geometric utilities for Project 
...
Core Components:
    ...
    2. HandsJointAngles: Computes a 20-DOF kinematic hand model (Flexion/Abduction).
    3. HandData: Granular dataclass for per-hand poses, raw/optimized velocities, 
       and grasp states.
    4. Hands: Sequence-level container for multi-frame data aggregation and JSON export.

Technical Specifics:
    - Landmark Map: Based on the Project 21-point hand tracking model.
