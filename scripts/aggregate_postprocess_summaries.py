...
def main() -> None:
    ...
    metric_paths = {
        ...
        "mink_training_quality_score": "simulation.training_quality_score",
        "training_action_eligible_ratio": "training_actions.eligible_ratio",
        "training_action_records": "training_actions.records",
        "hardware_trajectory_frames": "hardware_export.frame_count",
        "hardware_trajectory_duration_sec": "hardware_export.duration_sec",
        "hardware_arm_speed_max_rad_s": "hardware_export.arm_speed_max_rad_s",
        "hardware_arm_acceleration_max_rad_s2": "hardware_export.arm_acceleration_max_rad_s2",
        "hardware_fk_to_ik_target_position_error_max_m": "hardware_export.fk_to_ik_target_position_error_max_m",
    }
    distributions = {
        ...
        session_rows.append(
            {
                ...
                "mink_training_quality_score": get(row, "simulation.training_quality_score"),
                "training_eligible": get(row, "simulation.training_eligible"),
                "training_action_records": get(row, "training_actions.records"),
                "training_action_eligible_records": get(row, "training_actions.eligible_records"),
                "training_action_eligible_ratio": get(row, "training_actions.eligible_ratio"),
                "hardware_export_available": get(row, "hardware_export.available"),
                "hardware_offline_preflight_pass": get(row, "hardware_export.offline_preflight_pass"),
                "hardware_execution_authorized": get(row, "hardware_export.hardware_execution_authorized"),
                "hardware_trajectory_frames": get(row, "hardware_export.frame_count"),
                "end_effector_trajectory_available": get(row, "hardware_export.end_effector_available"),
    ...
    payload = {
        ...
        "summary": {
            ...
            "training_eligible_counts": count_bool(rows, "simulation.training_eligible"),
            "training_actions_available_counts": count_bool(rows, "training_actions.available"),
            "hardware_export_available_counts": count_bool(rows, "hardware_export.available"),
            "hardware_offline_preflight_counts": count_bool(rows, "hardware_export.offline_preflight_pass"),
            "end_effector_trajectory_available_counts": count_bool(rows, "hardware_export.end_effector_available"),
            ...
            "total_training_action_records": sum(int(value) for row in rows if (value := finite_number(get(row, "training_actions.records"))) is not None),
            "total_eligible_training_action_records": sum(int(value) for row in rows if (value := finite_number(get(row, "training_actions.eligible_records"))) is not None),
            "total_hardware_trajectory_frames": sum(int(value) for row in rows if (value := finite_number(get(row, "hardware_export.frame_count"))) is not None),
        },
