...
def write_html(session: Path, chart_rows: List[Dict[str, Any]], trajectory_data: Dict[str, Any], frame_times: List[float], fps: float = 30.0, output_subdir: str = "web") -> Path:
